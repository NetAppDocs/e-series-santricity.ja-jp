...
Unified Manager は、ドメイン全体の管理に使用する Web ベースのソフトウェアです。EシリーズおよびEFシリーズの新しいすべてのアレイ（E2800、EF280、EF300、E5700、EF570など）のステータスをまとめて確認できます。 EF600に最適です。選択したストレージアレイに対してバッチ処理を実行することもできます。
