...
NOTE: EF80、EF50、EF600/EF600C、およびEF300/EF300Cストレージアレイは、同期ミラーリングまたはシンボリュームをサポートしていません。
...
Unified Managerは、ドメイン全体を管理するために使用されるWebベースのソフトウェアです。中央ビューから、EF80、EF50、E4000、E2800、EF280、EF300、E5700、EF570、EF600、EF300C、EF600Cなど、すべての新しいEシリーズおよびEFシリーズアレイのステータスを確認できます。選択したストレージアレイに対してバッチ操作を実行することもできます。
