...
.手順
. System Managerで、シャーシのシリアル番号を確認し、記録してください。左側のパネルからメニュー：Support[Suport Center]を選択し、*View top storage array properties*までスクロールダウンして、シャーシのシリアル番号を表示します。
. System Managerで、Feature Enable Identifierを探します。左側のパネルからmenu:Settings[System]を選択し、下にスクロールして*Add-ons*を探します。*Feature Enable Identifier*を探してください。Feature Enable Identifierの番号を記録してください。
